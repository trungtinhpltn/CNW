...
<body>
	...
	<div class="container">
		<div class="grid wide">
			<div class="row">
				<h3 class="page-header">Danh sách các bài thi thử</h3>
			</div>
			
			<div class="row" style="margin-top: 50px;margin-bottom: 50px">
				<c:forEach items="${listBaiThi}" var="list">
					<div class="col l-4 m-4 c-12 center">
						<p class="item_name">${list.tName}</p>
						<a href="CTbaithiForward?mabaithi=${list.tID}" class="btn" type="button" onclick="return check()">
						Xem bài hướng dẫn
						</a>
					</div>
				</c:forEach>
					...
					<ul class="pagination">
						...
						<c:if test="${numberpage == 1}">
							...
							<li><a class="page__number"
								href="ListbaithiForward?pageId=${numberpage+1}">Next</a></li>
						</c:if>
						<c:if test="${numberpage == maxpageid}">
							<li><a class="page__number"
								href="ListbaithiForward?pageId=${numberpage-1}">Prev</a></li>
							<li class="disable"><a class="page__number" href="">Next</a></li>
						</c:if>
