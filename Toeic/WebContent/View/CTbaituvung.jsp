...
<head>
<meta charset="UTF-8">
<title>Làm bài tập từ vựng</title>
...
<link rel="stylesheet" href="cnweb/css/lambaitap.css">
	...
	<script type="text/javascript">
		function Xuatketqua()
		{
			...
			var url = "CTbaituvungForward?kq="+kq+"&num="+<%=request.getAttribute("numberpage")%>+"&mabaitv="+<%=request.getAttribute("vId")%>;
			if(kq ==""){
...
<body>
	...
	<div class="container">
		<div class="grid wide">
			<div class="row">
				<h3 class="page-header">Bài tập phần từ vựng</h3>
			</div>
				...
				<div class="phantrang">
					<ul class="pagination">
						...
						<input type="button" value="Đáp án" class="btn__DA"
							onclick="Xuatketqua()" />
						<li><a
							href="CTbaituvungForward?pageId=${numberpage}&mabaitv=${vId}"
						...
						<c:if test="${numberpage == 1}">
							...
							<li><a class="page__number"
								href="CTbaituvungForward?pageId=${numberpage+1}&mabaitv=${vId}">Next</a></li>
						</c:if>
						<c:if test="${numberpage == maxpageid}">
							<li><a class="page__number"
								href="CTbaituvungForward?pageId=${numberpage-1}&mabaitv=${vId}">Prev</a></li>
							<input type="button" value="Đáp án" class="btn__DA"
								onclick="Xuatketqua()" />
							<li><a
								href="CTbaituvungForward?pageId=${numberpage}&mabaitv=${vId}"
            ...
            <div class="row" style="margin-top: 30px">
				<div class="phantrang">
					<ul class="pagination">
						...
						<li><a href="ListHdBaiTuVungForward?pageId=1"
